...
This directory contains the **source files** for the bbqPAINT example notebooks in jupytext format.
...
```bash
# Install the development optional depencencies of bbqPAINT
pip install ".[dev]"
