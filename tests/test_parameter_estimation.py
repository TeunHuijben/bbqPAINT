...
class TestParameterEstimator:
    ...
    def test_estimate_parameters_power_spectrum_only(self, sample_trace, analysis_params):
    ...
    def test_fit_power_spectrum(self, sample_trace, analysis_params):
        ...
        freq_vec, power_spec = estimator.spectral_analyzer.calculate_power_spectrum(sample_trace)
    ...
    def test_parameter_estimation_with_custom_bounds(self, sample_trace, analysis_params):
    ...
    def test_parameter_estimation_with_custom_initial_guess(self, sample_trace, analysis_params):
